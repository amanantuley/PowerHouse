      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="relative h-96 md:h-[500px] rounded-lg overflow-hidden shadow-2xl group animate-slide-in-left">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {facilities.map((facility, index) => (
              <Link href="/facilities" key={index} className="relative h-80 overflow-hidden rounded-xl group shadow-lg animate-fade-in" style={{animationDelay: `${index * 150}ms`}}>
        ...
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {transformations.slice(0,3).map((t, index) => {
                    ...
                    return (
                        <div key={t.id} className="text-center animate-fade-in" style={{animationDelay: `${index * 200}ms`}}>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-center">
                {memberships.map((plan, index) => (
                    <Card key={plan.name} className={`flex flex-col rounded-xl overflow-hidden transition-all duration-300 hover:shadow-primary/20 hover:shadow-2xl hover:-translate-y-2 animate-fade-in ${plan.isPopular ? 'border-primary border-2 scale-105' : 'border-border'}`} style={{animationDelay: `${index * 200}ms`}}>
                        {plan.isPopular && (
